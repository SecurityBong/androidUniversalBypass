...
Java.perform(function () {
    ...
    try {
        ...
        try {
            ...
            send('TrustManagerImpl class not found');
        }
        ...
        try {
            ...
            send('OkHTTP3 class not found');
        }
    } catch (err) {
        send('SSL Pinning Bypass failed');
    }
    ...
    // Hook BiometricPrompt.authenticate methods
    function hookBiometricPrompt() {
        try {
            ...
            send('BiometricPrompt class not supported or hook failed');
        }
    }

    // Hook FingerprintManager.authenticate methods
    function hookFingerprintManager() {
        try {
            ...
            send('FingerprintManager class not supported or hook failed');
        }
    }
    ...
    // Bypass function to be triggered for manual testing
    function bypass() {
        Java.perform(function () {
            try {
                ...
                console.log("Bypass execution error: " + e);
            }
        });
    }
    ...
    try {
        ...
        send('Debugger Detection Bypass failed');
    }
